...
_c61(this,q);
}},currentText:"Today",cleanText:"Clean",closeText:"Close",okText:"Ok",buttons:[{text:function(_c76){
...
return $(_c80).datebox("options").cleanText;  
},handler : function(_c81) {  
$(_c81).combo('setValue', '').combo('setText', '');  
$(this).closest("div.combo-panel").panel("close");  
}}],formatter:function(date){
