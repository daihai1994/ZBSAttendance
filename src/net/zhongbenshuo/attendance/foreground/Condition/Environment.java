...
public class Environment {
	...
	public String toString() {
		return "Condition [station=" + station + ", temperature=" + temperature + ", humidity=" + humidity + ", pm25="
				+ pm25 + ", pm10=" + pm10 + ", carbonDioxide=" + carbonDioxide + ", formaldehyde=" + formaldehyde
				+ ", illuminance=" + illuminance + ", stationRemarks=" + stationRemarks + ", name=" + name
				+ ", createTime=" + createTime + ", station_name=" + station_name + ", station_remarks="
				+ station_remarks + ", state=" + state + "]";
	}
