...
public class OverTimeRecordAudit {
	private int id;//加班审批记录ID
	private int over_time_record_id;//加班申请详情ID
	...
	public String toString() {
		return "OverTimeRecordAudit [id=" + id + ", over_time_record_id=" + over_time_record_id + ", user_id=" + user_id
